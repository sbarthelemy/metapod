...
#ifndef METAPOD_BACKWARD_TRAVERSAL_PREV_NG_HH
# define METAPOD_BACKWARD_TRAVERSAL_PREV_NG_HH
...
private:
  ...
  void visit_dispatch(Event, bwt_tree_tag) {
    Visitor<Robot, Event::next_node_id, Event::prev_node_id>::discover(arg0_, arg1_);
  }

public:
  BtwPrevVisitorWrapper(Arg0 &arg0, Arg1 &arg1) : arg0_(arg0), arg1_(arg1) {}
  template <typename Event>
...
struct backward_traversal_prev_ng
{
  template<typename Arg0, typename Arg1>
  static void run(Arg0 &arg0, Arg1 &arg1)
  {
    boost::mpl::for_each< bwt<Robot, start_node_id, end_node_id> >(
        internal::BtwPrevVisitorWrapper<Visitor, Robot, Arg0, Arg1>(arg0, arg1));
  }
};
