...
Eigen::Matrix< FloatType, Robot::NBDOF, Robot::NBDOF > Robot::H;
  ...
  const Matrix3d WAIST_LINK0::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia WAIST_LINK0::I = spatialInertiaMaker(WAIST_LINK0::mass, WAIST_LINK0::CoM, WAIST_LINK0::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(WAIST_P, 0, 1, 0);
  const std::string WAIST_P::name = "WAIST_P";
  const int WAIST_P::label = 1;
  ...
  const Matrix3d WAIST_LINK1::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia WAIST_LINK1::I = spatialInertiaMaker(WAIST_LINK1::mass, WAIST_LINK1::CoM, WAIST_LINK1::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(WAIST_R);
  const std::string WAIST_R::name = "WAIST_R";
  const int WAIST_R::label = 2;
  ...
  const Matrix3d WAIST_LINK2::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia WAIST_LINK2::I = spatialInertiaMaker(WAIST_LINK2::mass, WAIST_LINK2::CoM, WAIST_LINK2::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(CHEST, 0, 0, 1);
  const std::string CHEST::name = "CHEST";
  const int CHEST::label = 3;
  ...
  const Matrix3d WAIST_LINK3::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia WAIST_LINK3::I = spatialInertiaMaker(WAIST_LINK3::mass, WAIST_LINK3::CoM, WAIST_LINK3::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LARM_SHOULDER_P, 0, 1, 0);
  const std::string LARM_SHOULDER_P::name = "LARM_SHOULDER_P";
  const int LARM_SHOULDER_P::label = 4;
  ...
  const Vector3d LARM_LINK1::CoM = Vector3d(0.1, 0, 0);
  const Matrix3d LARM_LINK1::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK1::I = spatialInertiaMaker(LARM_LINK1::mass, LARM_LINK1::CoM, LARM_LINK1::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(LARM_SHOULDER_R);
  const std::string LARM_SHOULDER_R::name = "LARM_SHOULDER_R";
  const int LARM_SHOULDER_R::label = 5;
  ...
  const Matrix3d LARM_LINK2::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK2::I = spatialInertiaMaker(LARM_LINK2::mass, LARM_LINK2::CoM, LARM_LINK2::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LARM_SHOULDER_Y, 0, 0, 1);
  const std::string LARM_SHOULDER_Y::name = "LARM_SHOULDER_Y";
  const int LARM_SHOULDER_Y::label = 6;
  ...
  const Matrix3d LARM_LINK3::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK3::I = spatialInertiaMaker(LARM_LINK3::mass, LARM_LINK3::CoM, LARM_LINK3::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LARM_ELBOW, 0, 1, 0);
  const std::string LARM_ELBOW::name = "LARM_ELBOW";
  const int LARM_ELBOW::label = 7;
  ...
  const Matrix3d LARM_LINK4::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK4::I = spatialInertiaMaker(LARM_LINK4::mass, LARM_LINK4::CoM, LARM_LINK4::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LARM_WRIST_Y, 0, 0, 1);
  const std::string LARM_WRIST_Y::name = "LARM_WRIST_Y";
  const int LARM_WRIST_Y::label = 8;
  ...
  const Vector3d LARM_LINK5::CoM = Vector3d(0, 0, 0.1);
  const Matrix3d LARM_LINK5::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK5::I = spatialInertiaMaker(LARM_LINK5::mass, LARM_LINK5::CoM, LARM_LINK5::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LARM_WRIST_P, 0, 1, 0);
  const std::string LARM_WRIST_P::name = "LARM_WRIST_P";
  const int LARM_WRIST_P::label = 9;
  ...
  const Vector3d LARM_LINK6::CoM = Vector3d(-0.1, 0, 0);
  const Matrix3d LARM_LINK6::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK6::I = spatialInertiaMaker(LARM_LINK6::mass, LARM_LINK6::CoM, LARM_LINK6::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(LARM_WRIST_R);
  const std::string LARM_WRIST_R::name = "LARM_WRIST_R";
  const int LARM_WRIST_R::label = 10;
  ...
  const Matrix3d LARM_LINK7::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LARM_LINK7::I = spatialInertiaMaker(LARM_LINK7::mass, LARM_LINK7::CoM, LARM_LINK7::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RARM_SHOULDER_P, 0, 1, 0);
  const std::string RARM_SHOULDER_P::name = "RARM_SHOULDER_P";
  const int RARM_SHOULDER_P::label = 11;
  ...
  const Vector3d RARM_LINK1::CoM = Vector3d(0.1, 0, 0);
  const Matrix3d RARM_LINK1::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK1::I = spatialInertiaMaker(RARM_LINK1::mass, RARM_LINK1::CoM, RARM_LINK1::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(RARM_SHOULDER_R);
  const std::string RARM_SHOULDER_R::name = "RARM_SHOULDER_R";
  const int RARM_SHOULDER_R::label = 12;
  ...
  const Matrix3d RARM_LINK2::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK2::I = spatialInertiaMaker(RARM_LINK2::mass, RARM_LINK2::CoM, RARM_LINK2::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RARM_SHOULDER_Y, 0, 0, 1);
  const std::string RARM_SHOULDER_Y::name = "RARM_SHOULDER_Y";
  const int RARM_SHOULDER_Y::label = 13;
  ...
  const Matrix3d RARM_LINK3::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK3::I = spatialInertiaMaker(RARM_LINK3::mass, RARM_LINK3::CoM, RARM_LINK3::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RARM_ELBOW, 0, 1, 0);
  const std::string RARM_ELBOW::name = "RARM_ELBOW";
  const int RARM_ELBOW::label = 14;
  ...
  const Matrix3d RARM_LINK4::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK4::I = spatialInertiaMaker(RARM_LINK4::mass, RARM_LINK4::CoM, RARM_LINK4::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RARM_WRIST_Y, 0, 0, 1);
  const std::string RARM_WRIST_Y::name = "RARM_WRIST_Y";
  const int RARM_WRIST_Y::label = 15;
  ...
  const Vector3d RARM_LINK5::CoM = Vector3d(0, 0, 0.1);
  const Matrix3d RARM_LINK5::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK5::I = spatialInertiaMaker(RARM_LINK5::mass, RARM_LINK5::CoM, RARM_LINK5::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RARM_WRIST_P, 0, 1, 0);
  const std::string RARM_WRIST_P::name = "RARM_WRIST_P";
  const int RARM_WRIST_P::label = 16;
  ...
  const Vector3d RARM_LINK6::CoM = Vector3d(-0.1, 0, 0);
  const Matrix3d RARM_LINK6::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK6::I = spatialInertiaMaker(RARM_LINK6::mass, RARM_LINK6::CoM, RARM_LINK6::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(RARM_WRIST_R);
  const std::string RARM_WRIST_R::name = "RARM_WRIST_R";
  const int RARM_WRIST_R::label = 17;
  ...
  const Matrix3d RARM_LINK7::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RARM_LINK7::I = spatialInertiaMaker(RARM_LINK7::mass, RARM_LINK7::CoM, RARM_LINK7::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(LLEG_HIP_R);
  const std::string LLEG_HIP_R::name = "LLEG_HIP_R";
  const int LLEG_HIP_R::label = 18;
  ...
  const Matrix3d LLEG_LINK1::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK1::I = spatialInertiaMaker(LLEG_LINK1::mass, LLEG_LINK1::CoM, LLEG_LINK1::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LLEG_HIP_P, 0, 1, 0);
  const std::string LLEG_HIP_P::name = "LLEG_HIP_P";
  const int LLEG_HIP_P::label = 19;
  ...
  const Matrix3d LLEG_LINK2::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK2::I = spatialInertiaMaker(LLEG_LINK2::mass, LLEG_LINK2::CoM, LLEG_LINK2::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LLEG_HIP_Y, 0, 0, 1);
  const std::string LLEG_HIP_Y::name = "LLEG_HIP_Y";
  const int LLEG_HIP_Y::label = 20;
  ...
  const Vector3d LLEG_LINK3::CoM = Vector3d(0, 0.04, 0);
  const Matrix3d LLEG_LINK3::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK3::I = spatialInertiaMaker(LLEG_LINK3::mass, LLEG_LINK3::CoM, LLEG_LINK3::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LLEG_KNEE, 0, 1, 0);
  const std::string LLEG_KNEE::name = "LLEG_KNEE";
  const int LLEG_KNEE::label = 21;
  ...
  const Matrix3d LLEG_LINK4::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK4::I = spatialInertiaMaker(LLEG_LINK4::mass, LLEG_LINK4::CoM, LLEG_LINK4::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(LLEG_ANKLE_P, 0, 1, 0);
  const std::string LLEG_ANKLE_P::name = "LLEG_ANKLE_P";
  const int LLEG_ANKLE_P::label = 22;
  ...
  const Vector3d LLEG_LINK5::CoM = Vector3d(-0.15, 0, 0);
  const Matrix3d LLEG_LINK5::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK5::I = spatialInertiaMaker(LLEG_LINK5::mass, LLEG_LINK5::CoM, LLEG_LINK5::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(LLEG_ANKLE_R);
  const std::string LLEG_ANKLE_R::name = "LLEG_ANKLE_R";
  const int LLEG_ANKLE_R::label = 23;
  ...
  const Matrix3d LLEG_LINK6::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia LLEG_LINK6::I = spatialInertiaMaker(LLEG_LINK6::mass, LLEG_LINK6::CoM, LLEG_LINK6::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(RLEG_HIP_R);
  const std::string RLEG_HIP_R::name = "RLEG_HIP_R";
  const int RLEG_HIP_R::label = 24;
  ...
  const Matrix3d RLEG_LINK1::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK1::I = spatialInertiaMaker(RLEG_LINK1::mass, RLEG_LINK1::CoM, RLEG_LINK1::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RLEG_HIP_P, 0, 1, 0);
  const std::string RLEG_HIP_P::name = "RLEG_HIP_P";
  const int RLEG_HIP_P::label = 25;
  ...
  const Matrix3d RLEG_LINK2::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK2::I = spatialInertiaMaker(RLEG_LINK2::mass, RLEG_LINK2::CoM, RLEG_LINK2::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RLEG_HIP_Y, 0, 0, 1);
  const std::string RLEG_HIP_Y::name = "RLEG_HIP_Y";
  const int RLEG_HIP_Y::label = 26;
  ...
  const Vector3d RLEG_LINK3::CoM = Vector3d(0, -0.04, 0);
  const Matrix3d RLEG_LINK3::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK3::I = spatialInertiaMaker(RLEG_LINK3::mass, RLEG_LINK3::CoM, RLEG_LINK3::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RLEG_KNEE, 0, 1, 0);
  const std::string RLEG_KNEE::name = "RLEG_KNEE";
  const int RLEG_KNEE::label = 27;
  ...
  const Matrix3d RLEG_LINK4::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK4::I = spatialInertiaMaker(RLEG_LINK4::mass, RLEG_LINK4::CoM, RLEG_LINK4::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_ANY(RLEG_ANKLE_P, 0, 1, 0);
  const std::string RLEG_ANKLE_P::name = "RLEG_ANKLE_P";
  const int RLEG_ANKLE_P::label = 28;
  ...
  const Vector3d RLEG_LINK5::CoM = Vector3d(-0.15, 0, 0);
  const Matrix3d RLEG_LINK5::inertie = matrix3dMaker(
    1, 0, 0,
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK5::I = spatialInertiaMaker(RLEG_LINK5::mass, RLEG_LINK5::CoM, RLEG_LINK5::inertie);

  INITIALIZE_JOINT_REVOLUTE_AXIS_X(RLEG_ANKLE_R);
  const std::string RLEG_ANKLE_R::name = "RLEG_ANKLE_R";
  const int RLEG_ANKLE_R::label = 29;
  ...
  const Matrix3d RLEG_LINK6::inertie = matrix3dMaker(
    ...
    0, 1, 0,
    0, 0, 1);
  Spatial::Inertia RLEG_LINK6::I = spatialInertiaMaker(RLEG_LINK6::mass, RLEG_LINK6::CoM, RLEG_LINK6::inertie);

} // closing namespace simple_humanoid
